...
class ChatbotWindow:
    def __init__(self, root, user_id=None):
        ...
        self.ai = ChatbotService(user_id)
        ...
        self.txt_history = ctk.CTkTextbox(self.root, corner_radius=12, fg_color="#1E222B", border_width=1, border_color="#2D3139", font=("Arial", 12), spacing3=8, wrap="word")
        ...
        self.append_bubble("AI Desk", "System tracking connection verified. How can I help you today? Type 'help' for available commands.")
